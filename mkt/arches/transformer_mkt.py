...
# )
from .transformer_adapter import TransformerModelAdapter

@register_model("transformer_adapter")
class TransformerAdapterModel(TransformerModelAdapter):
    """
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument("--adapter-inner-dims", type=int, default=256, help='the dim of serial adapter.',)
        #parser.add_argument("--adapter-output-dims", type=int, default=1024, help='the output dim of serial adapter.',)
    ...
    def build_model(cls, args, task):
        ...
        base_adapter_architecture(args)
        ...
        if args.share_all_embeddings:
            ...
            # print(args.share_decoder_input_output_embed)
            # import sys
            # sys.exit(2)
    ...
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens, base_embed_tokens):
        return super().build_encoder(
            TransformerConfig.from_namespace(args), src_dict, embed_tokens, base_embed_tokens
        )

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens, base_embed_tokens):
        return super().build_decoder(
            TransformerConfig.from_namespace(args), tgt_dict, embed_tokens, base_embed_tokens
        )
...
@register_model_architecture("transformer_adapter", "transformer_adapter")
def base_adapter_architecture(args):
    ...
    # custom
    args.adapter_inner_dims = getattr(args, "adapter_inner_dims", 256)
    #args.adapter_output_dims = getattr(args, "adapter_output_dims", 1024)